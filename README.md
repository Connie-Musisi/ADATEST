...
## Analysis Code 
 ...
 The folder [`Code_for_simulating data/`](./All_analysis_Code/Code_for_simulating data) provides the R scripts `Simulate_data` used to generate the simulated datasets, starting with using `MIDASim` to simulate the counts and then creating a phyloseq object for each simulated count dataset.
